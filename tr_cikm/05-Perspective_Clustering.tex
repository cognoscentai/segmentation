...
\\
---- ADD BRIEF ALGO DESCRIPTION \\
\\ Add the processed segmentation image that shows gt? \\

%the cost of data collection. %(which is cheaper and more accurate than segmentation)
