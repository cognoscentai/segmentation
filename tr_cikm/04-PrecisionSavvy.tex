...
\par \noindent Assume all worker and tile equal, this simple algorithm includes a tile in the output segmentation if and only if the tile has `yes' votes from at least 50\% of all worker segmentations.
