#!/bin/bash
#nohup python2.7 initPixelAnalysis.py 5workers_rand0 > 5workers_rand0.out &
#nohup python2.7 initPixelAnalysis.py 5workers_rand1 > 5workers_rand1.out &
...
nohup python2.7 initPixelAnalysis.py 10workers_rand7 > 10workers_rand7.out &
...
#nohup python2.7 initPixelAnalysis.py 20workers_rand0 > 20workers_rand0.out &
#nohup python2.7 initPixelAnalysis.py 20workers_rand1 > 20workers_rand1.out &
nohup python2.7 initPixelAnalysis.py 20workers_rand2 > 20workers_rand2.out &
nohup python2.7 initPixelAnalysis.py 20workers_rand3 > 20workers_rand3.out &

#nohup python2.7 initPixelAnalysis.py 25workers_rand0 > 25workers_rand0.out &
#nohup python2.7 initPixelAnalysis.py 25workers_rand1 > 25workers_rand1.out &

#nohup python2.7 initPixelAnalysis.py 30workers_rand0 > 30workers_rand0.out &
