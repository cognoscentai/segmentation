...
\stitle{Aggregation-based methods perform significantly better than retrieval-based methods}
...
\stitle{Performance of aggregation-based methods scales well as more worker segmentations are added.}
