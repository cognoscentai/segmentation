...
\begin{table}[h!]
   \small
     \setlength\tabcolsep{1.5pt}
      ...
      \end{tabular}
      \caption{Percentage change due to worker scaling and clustering preprocessing. Algorithms with * makes use of ground truth information.}
      \label{statsTable}
\end{table}