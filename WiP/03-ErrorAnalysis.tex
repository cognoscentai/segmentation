...
Since quality evaluation methods in past literature have largely focused on minimizing boundary precision issues, we first describe our novel aggregation-based algorithms designed to reduce boundary imprecision and compare them with existing retrieval-based methods in Section~\ref{sec:precision}.% for addressing boundary imprecision. 
